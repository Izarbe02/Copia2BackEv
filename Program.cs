...
//Inyeccion repo
 builder.Services.AddScoped<IComentarioRepository, ComentarioRepository>(provider =>
    ...
    builder.Services.AddScoped<IPatrocinadorRepository, PatrocinadorRepository>(provider =>
        new PatrocinadorRepository(connectionString));
...
builder.Services.AddScoped<IPatrocinadorService, PatrocinadorService>();
